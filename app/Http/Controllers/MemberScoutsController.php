...
class MemberScoutsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admins.central.member', compact('members'));
    }

    public function create()
    {
        return view('admins.central.create');
    }
    ...
    public function store(Request $request)
{
    try {
        ...
        return redirect()->route('members.list')->with('success', 'Member created successfully.');
    } catch (\Exception $e) {
    ...
    public function show(Request $request ,$id)
    {
        ...
        return view('admins.central.show', compact('member'));
    }

    public function edit($id)
    {
        $member = MemberScouts::findOrFail($id);
        return view('admins.central.edit', compact('member'));
    }
    ...
    public function activite()
    {
        ...
        return view('admins.central.activity.activity', compact('activity'));
    }
    public function Create_activite()
    {
        return view('admins.central.activity.create_activity');
    }
    ...
    public function store_activite(Request $request)
    {
        try {
            ...
            return redirect()->route('central.showactivity')->with('success', 'Activity created successfully.');
        } catch (\Exception $e) {
