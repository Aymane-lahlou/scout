...
class Region extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admins.Region.member', compact('members'));
    }

    public function create()
    {
        return view('admins.Region.create');
    }
    ...
    public function store(Request $request)
{
    try {
        ...
        return redirect()->route('Region.list')->with('success', 'Member created successfully.');
    } catch (\Exception $e) {
    ...
    public function show(Request $request ,$id)
    {
        ...
        return view('admins.Region.show', compact('member'));
    }

    public function edit($id)
    {
        $member = MemberScouts::findOrFail($id);
        return view('admins.Region.edit', compact('member'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // return $request;
        return redirect()->route('Region.list')->with('success', 'Member updated successfully.');
    }
    public function destroy($id)
    {
        MemberScouts::where('id',$id)->delete();

        return redirect()->route('Region.list')->with('success', 'Member deleted successfully.');
    }
    public function activite()
    {
        $activity = Activity::all();

        return view('admins.Region.activity.activity', compact('activity'));
    }
    public function Create_activite()
    {
        return view('admins.Region.activity.create_activity');
    }
    ...
    public function store_activite(Request $request)
    {
        try {
            ...
            return redirect()->route('Region.showactivity')->with('success', 'Activity created successfully.');
        } catch (\Exception $e) {
