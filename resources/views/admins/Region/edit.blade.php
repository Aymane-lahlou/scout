...
@section('content')
    ...
    <form action="{{ route('Region.update', $member->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="number" name="NLA" value="{{ old('Niveau_de_langue_anglais', $member->getAttribute('Niveau de langue anglais')) }}" min="0" max="5"></td>
                </tr>
                <tr>
