...
<form action="{{ route('delete_All_member_super') }}" method="post">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{ route('members_super.show', $member->id) }}">Show</a>
          <a href="{{ route('members_super.edit', $member->id) }}">Edit</a>
            <a href="{{route('members_super.destroy' , $member->id)}}" type="button"> delte</a> </td>
          </form>
        </td>
      </tr>
      @endforeach
